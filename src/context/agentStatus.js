...
export function getStatusForStep(step) {
  ...
  switch (step.step_type) {
    ...
    case "fallback_trying":
      return { label: `Trying ${step.agent_id}...`, icon: "sparkle" };

    case "fallback_retrying":
      return { label: `Retrying ${step.agent_id}...`, icon: "sparkle" };

    case "fallback_failed":
      return { label: `Switching from ${step.agent_id}...`, icon: "sparkle" };
